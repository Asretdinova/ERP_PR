...
<div class="main-content">
    <breadcumb :page="'republican_administration'" :folder="'list'" />
        ...
        <vue-good-table :columns="columns" :search-options="{
          ...
          placeholder: 'Search this table'
            ...
            <div slot="table-actions" class="mb-3">
                <router-link to="/republican-administration/create">
            ...
            <template slot="table-row" slot-scope="props">
                <span v-if="props.column.field == 'action'">
                    <router-link :to="'/republican-administration/edit/'+props.row.id">
