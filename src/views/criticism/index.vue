        ...
        <b-card class="wrapper">
            <b-card-text>
                <div class="row">
                    ...
                    <b-col md="2">
                        <b-form-select class="mb-2" :value="null" v-model="this.administration" :options="selected_adm"
                            id="inline-form-custom-select-pref" label="name">
                            <option slot="first" :value="null">{{ $t("message.category") }}</option>
                        </b-form-select>
                    </b-col> -->

                    <b-col md="3" class="vh-100 text-right" align-v="center">
