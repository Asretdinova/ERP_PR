<template>
    <div class="main-content">
        <breadcumb :page="'articles'" :folder="'list'" />
    ...
    initialSortBy: { field: 'id', type: 'desc' }
                ...
                <template slot="table-row" slot-scope="props">
                    <span v-if="props.column.field == 'action'">
                        <router-link :to="'/articles/edit/' + props.row.id">
...
export default {
    ...
    computed: {
        ...
        columns: function () {
            ...
            {
                label: this.$t('message.article_title'),
                field: function (val) {
                    return val['name_' + lang]
                }
            },
            {
                label: this.$t('message.control_type'),
                field: function (val) {
            ...
            {
                label: this.$t('message.name_creator'),
                field: "created_by.first_name",
                // field: function (val) {
                //     return val.created_by.first_name
                // }
            },
            {
