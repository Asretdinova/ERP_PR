...
<div class="main-content">
    <breadcumb :page="'press_secretaries'" :folder="'list'" />
    <b-card class="wrapper">
        <vue-good-table :columns="columns" :search-options="{
          ...
          placeholder: 'Search this table'
            ...
            <div slot="table-actions" class="mb-3">
                <router-link to="/press-secretaries/create">
            ...
            <template slot="table-row" slot-scope="props">
                <span v-if="props.column.field == 'action'">
                    <router-link :to="'/press-secretaries/edit/'+props.row.id">
        ...
        <b-modal centered :title="$t('message.delete_title')" size="lg" ref="modal_info" header-bg-variant="danger" ok-variant="success" :ok-title="$t('message.yes')" :cancel-title="$t('message.no')" @ok="deleteAdmin">
            ...
            <b-tabs active-nav-item-class="nav nav-tabs" content-class="mt-3" v-model="tabIndex">
                <b-tab :title="$t('message.articles')">
                ...
                <b-tab :title="$t('message.criticism')">
                    <b-table-simple responsive>
                        <b-tbody>
                ...
                <b-tab :title="$t('message.media_inquiries')">
                    <b-table-simple responsive>
                        <b-tbody>
...
export default {
    ...
    computed: {
        ...
        columns: function () {
            ...
            return [
                ...
                {
                    label: this.$t('message.press_name'),
                    field: function (val) {
    ...
    methods: {
        ...
        confirmMessage(id) {
            getPressSecretariesId(id).then(res => {
        ...
        deleteAdmin() {
            deletePressSecretaries(this.delete_id).then(() => {
                this.fetchData()
