<template>
    <div class="main-content">
        <breadcumb :page="'territorial_administration'" :folder="title_form" back="true" />
                ...
                <div class="row">
                    ...
                    <b-col md="6">
                        ...
                        <b-form-group :label="$t('message.phone_number')"
                            ...
                            <b-form-input class="mb-2" label="title"
                                :state="$v.submitData.phone.$dirty ? !$v.submitData.phone.$error : null"
                                v-model="submitData.phone" v-mask="['(+998) ##-###-##-##']"
                    ...
                    <b-col class="text-right">
                        ...
                        <b-button type="submit" variant="primary" class="d-inline "
                            :disabled="submitStatus === 'PENDING'">{{ $t('message.submit') }}</b-button>
                    </b-col>
                </div>
            </b-form>
        </b-card>
        ...
        submit() {
            ...
            if (this.$route.params.id) {
                putAdministration(this.submitData, this.$route.params.id).then(() => {
                    ...
                    this.$router.push("/territorial-administration/index");
                }).catch(error => {
