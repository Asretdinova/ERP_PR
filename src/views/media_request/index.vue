...
<div class="main-content">
    <breadcumb :page="'media_inquiries'" :folder="'list'" />
        ...
        <vue-good-table :columns="columns" :search-options="{
          ...
          placeholder: 'Search this table'
            ...
            <div slot="table-actions" class="mb-3">
                <router-link to="/media-request/create" v-if="users.role === 3">
            ...
            <template slot="table-row" slot-scope="props">
                <span v-if="props.column.field == 'action'">
                    <router-link :to="'/media-request/edit/'+props.row.id">
...
export default {
    ...
    computed: {
        ...
        columns: function () {
            ...
            var type_status = {
                '1': this.$t('message.in_work'),
                '2': this.$t('message.on_check'),
            ...
            return [{
                ...
                {
                    label: this.$t('message.request_name'),
                    field: "name",
                },
                {
                ...
                {
                    label: this.$t('message.journalist'),
                    field: "journalist.fio",
                },
                {
